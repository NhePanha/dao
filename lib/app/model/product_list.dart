...
List<Product> allProducts = [
  Product('assets/images/banana.png', 'Organic Bananas', '7pcs, Priceg', 4.99),
  Product('assets/images/apple.png', 'Red Apple', '1kg, Priceg', 4.55),
  Product('assets/images/pepper.png', 'Red Pepper', '1kg, Priceg', 7.99),
  Product('assets/images/ginger.png', 'Ginger', '500g, Priceg', 2.99),
  Product('assets/images/tomato.png', 'Fresh Tomatoes', '1kg, Priceg', 3.49),
